...
const Details = ({position,company,companyLink,time,address,work}) =>{
    ...
    return <li ref={ref} className='my-8 first:mt-0 last:mb:0 w-[60%] mx-auto flex items-center justify-between'>
        ...
        >
            ...
            href={companyLink} className='text-sky-700 capitalize'
            >-{company}</a></h3>
